...
--
-- Name: vectors; Type: SCHEMA; Schema: -; Owner: -
--
...
CREATE FUNCTION public.api_search_content_with_highlights(query_text text, result_limit integer DEFAULT 10, snippet_length integer DEFAULT 200) RETURNS json
    ...
    AS $$
BEGIN
    -- Fast ILIKE search (was working this morning)
    RETURN (
...
--
-- Name: check_embedding_write_locations(); Type: FUNCTION; Schema: vectors; Owner: -
--

CREATE FUNCTION vectors.check_embedding_write_locations() RETURNS TABLE(chunk_embeddings_recent integer, chunks_recent integer, workers_writing_wrong_location boolean, recommendation text)
    LANGUAGE plpgsql
    AS $$
DECLARE
    ce_recent INTEGER;
...
--
-- Name: generate_chunk_embeddings_batch(text[], character varying); Type: FUNCTION; Schema: vectors; Owner: -
--

CREATE FUNCTION vectors.generate_chunk_embeddings_batch(chunk_ids text[], embedding_model character varying DEFAULT 'nomic-embed-text'::character varying) RETURNS TABLE(chunk_id character varying, embedding_generated boolean, model_used character varying, processing_time interval)
    LANGUAGE plpgsql
    AS $$
DECLARE
    chunk_id_val TEXT;
...
--
-- Name: get_embedding_model_usage_stats(); Type: FUNCTION; Schema: vectors; Owner: -
--

CREATE FUNCTION vectors.get_embedding_model_usage_stats() RETURNS TABLE(embedding_model character varying, total_embeddings bigint, avg_processing_time_ms numeric, content_types text[], last_used timestamp without time zone)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: FUNCTION get_embedding_model_usage_stats(); Type: COMMENT; Schema: vectors; Owner: -
--

COMMENT ON FUNCTION vectors.get_embedding_model_usage_stats() IS 'Usage analytics for embedding model optimization';


--
-- Name: get_embedding_system_status(); Type: FUNCTION; Schema: vectors; Owner: -
--

CREATE FUNCTION vectors.get_embedding_system_status() RETURNS TABLE(embedding_type text, vector_count bigint, table_size text, index_count integer, last_updated timestamp without time zone)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_fast_representative_embedding(); Type: FUNCTION; Schema: vectors; Owner: -
--

CREATE FUNCTION vectors.get_fast_representative_embedding() RETURNS public.vector
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: get_optimal_embedding_model(character varying, character varying, integer, character varying); Type: FUNCTION; Schema: vectors; Owner: -
--

CREATE FUNCTION vectors.get_optimal_embedding_model(p_content_type character varying, p_language character varying DEFAULT 'en'::character varying, p_chunk_length integer DEFAULT 1000, p_book_genre character varying DEFAULT NULL::character varying) RETURNS character varying
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: FUNCTION get_optimal_embedding_model(p_content_type character varying, p_language character varying, p_chunk_length integer, p_book_genre character varying); Type: COMMENT; Schema: vectors; Owner: -
--

COMMENT ON FUNCTION vectors.get_optimal_embedding_model(p_content_type character varying, p_language character varying, p_chunk_length integer, p_book_genre character varying) IS 'Intelligent routing function - returns best embedding model based on content analysis';


--
-- Name: get_phase_1_2_chunks_for_embedding(integer, text); Type: FUNCTION; Schema: vectors; Owner: -
--

CREATE FUNCTION vectors.get_phase_1_2_chunks_for_embedding(batch_size integer DEFAULT 1000, embedding_type text DEFAULT 'all'::text) RETURNS TABLE(chunk_id character varying, content text, chunk_type character varying, character_count integer, word_count integer, book_id integer, chapter_number integer, section_number integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: safe_batch_migrate_embeddings(integer); Type: FUNCTION; Schema: vectors; Owner: -
--

CREATE FUNCTION vectors.safe_batch_migrate_embeddings(batch_size integer DEFAULT 100) RETURNS TABLE(batch_number integer, records_migrated integer, total_migrated integer, success boolean, message text)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: validate_embedding_search_capability(); Type: FUNCTION; Schema: vectors; Owner: -
--

CREATE FUNCTION vectors.validate_embedding_search_capability() RETURNS TABLE(chunks_with_embeddings integer, sample_search_works boolean, vector_dimensions integer, search_ready boolean, message text)
    LANGUAGE plpgsql
    AS $$
DECLARE
    embed_count INTEGER;
...
--
-- Name: FUNCTION vector_cross_reference_search(search_term text, query_embedding public.vector, max_results integer); Type: COMMENT; Schema: vectors; Owner: -
--

COMMENT ON FUNCTION vectors.vector_cross_reference_search(search_term text, query_embedding public.vector, max_results integer) IS 'Vector-first cross-reference search replacing slow window function approach';
...
--
-- Name: api_search_analytics api_search_analytics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.api_search_analytics
    ADD CONSTRAINT api_search_analytics_pkey PRIMARY KEY (id);
...
--
-- Name: idx_api_search_analytics_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_api_search_analytics_created_at ON public.api_search_analytics USING btree (created_at);


--
-- Name: idx_api_search_analytics_search_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_api_search_analytics_search_type ON public.api_search_analytics USING btree (search_type);
...
--
-- Name: idx_chunk_embeddings_model_chunk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_embeddings_model_chunk ON public.chunk_embeddings USING btree (embedding_model, chunk_id);
...
--
-- Name: idx_chunks_chunk_type_content; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_chunk_type_content ON public.chunks USING btree (chunk_type, book_id) WHERE (content IS NOT NULL);
...
--
-- Name: idx_chunks_content_not_null; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_content_not_null ON public.chunks USING btree (chunk_id) WHERE (content IS NOT NULL);
...
--
-- Name: idx_chunks_embedding_vector_optimized; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_embedding_vector_optimized ON public.chunks USING ivfflat (embedding_vector public.vector_cosine_ops) WHERE (embedding_vector IS NOT NULL);


--
-- Name: idx_chunks_fullbook_case_sensitive_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_fullbook_case_sensitive_trgm ON public.chunks USING gin (content public.gin_trgm_ops) WHERE ((chunk_type)::text = 'fullbook'::text);


--
-- Name: idx_chunks_fullbook_fts; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_fullbook_fts ON public.chunks USING gin (content_fts) WHERE (((chunk_type)::text = 'fullbook'::text) AND (content_fts IS NOT NULL));


--
-- Name: idx_chunks_fullbook_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_fullbook_trgm ON public.chunks USING gin (lower(content) COLLATE "C" public.gin_trgm_ops) WHERE ((chunk_type)::text = 'fullbook'::text);
...
CREATE INDEX idx_chunks_similarity_optimized ON public.chunks USING btree (semantic_archive.similarity(content, 'common search terms'::text)) WHERE ((content IS NOT NULL) AND ((length(content) >= 100) AND (length(content) <= 1000)));
...
--
-- Name: idx_universal_content_search; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_universal_content_search ON public.chunks USING gin (content public.gin_trgm_ops) WHERE ((content IS NOT NULL) AND ((length(content) >= 50) AND (length(content) <= 2000)));


--
-- Name: idx_universal_content_search_complete; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_universal_content_search_complete ON public.chunks USING gin (content public.gin_trgm_ops) WHERE (content IS NOT NULL);


--
-- Name: idx_universal_trigram_step1; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_universal_trigram_step1 ON public.chunks USING gin (content public.gin_trgm_ops) WHERE ((content IS NOT NULL) AND ((length(content) >= 50) AND (length(content) <= 2000)));
