...
def _handle_semantic_search(query: str, limit: int, response_format: str, sort_field: str, embedding_model: str = 'gemini-embedding-001', ensemble: bool = False):
    """Handle semantic search using PostgreSQL functions with model selection"""
    try:
        # Validate embedding model
        valid_models = ['gemini-embedding-001', 'snowflake-arctic-embed2', 'bge-m3']
        ...
        if ensemble:
            ...
            result = execute_pg_function('api_semantic_ensemble_search', query, ['gemini-embedding-001', 'bge-m3'], [0.6, 0.4], limit)
        else:
...
def _handle_discovery_search(query: str, limit: int, response_format: str, sort_field: str, embedding_model: str = 'gemini-embedding-001'):
...
def _handle_style_search(query: str, limit: int, response_format: str, sort_field: str, embedding_model: str = 'gemini-embedding-001'):
...
def _handle_quality_search(query: str, limit: int, response_format: str, sort_field: str, embedding_model: str = 'gemini-embedding-001', quality_threshold: float = 0.6):
