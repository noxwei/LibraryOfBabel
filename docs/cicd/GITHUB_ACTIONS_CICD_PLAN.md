...
**Production Target**: api.example.com  
...
jobs:
  deploy-production:
    ...
    steps:
      - uses: actions/checkout@v3
      - name: Deploy to api.example.com
        run: |
...
- **Server**: api.example.com production environment
...
deploy-production:
  steps:
    - name: Pre-deployment Health Check
      run: |
        curl -f https://api.example.com/api/v3/health
...
*Date: 2025-07-09*  
*Target: api.example.com production deployment*