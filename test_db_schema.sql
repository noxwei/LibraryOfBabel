...
--
-- Name: api_emergency_hybrid_search(text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_emergency_hybrid_search(search_text text, result_limit integer DEFAULT 20) RETURNS TABLE(chunk_id text, content text, similarity_score real, match_type text, book_id integer, title text, author text, embedding_model text)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: api_emergency_search_status(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_emergency_search_status() RETURNS TABLE(system_status text, available_embeddings integer, search_ready boolean, recommendation text)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: api_emergency_search_working(text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_emergency_search_working(search_text text, result_limit integer DEFAULT 10) RETURNS TABLE(chunk_id text, content text, similarity_score real, book_id integer, title text, author text, embedding_model text, confidence_level text)
    LANGUAGE plpgsql
    AS $$
BEGIN
    -- Input validation
...
--
-- Name: api_emergency_semantic_search(text, integer, real); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_emergency_semantic_search(search_query text, result_limit integer DEFAULT 20, similarity_threshold real DEFAULT 0.7) RETURNS TABLE(chunk_id text, content text, similarity_score real, book_id integer, title text, author text, embedding_model text, confidence_level text)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: api_emergency_vector_search(public.vector, integer, real); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_emergency_vector_search(query_vector public.vector, result_limit integer DEFAULT 20, similarity_threshold real DEFAULT 0.7) RETURNS TABLE(chunk_id text, content text, similarity_score real, book_id integer, title text, author text, embedding_model text)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public.api_extended_semantic_search(p_query text, p_limit integer DEFAULT 50) RETURNS TABLE(chunk_id character varying, content text, title character varying, author character varying, semantic_score real, match_type text, phrase_matches text[], query_complexity real, execution_time_ms integer)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: api_extended_semantic_stats(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_extended_semantic_stats() RETURNS TABLE(total_extended_concepts integer, total_ngrams integer, avg_query_complexity real, avg_execution_time_ms real, popular_fallback_tier integer, performance_trend text)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY SELECT
...
--
-- Name: api_fast_author_phonetic_search(text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_fast_author_phonetic_search(author_query text, search_limit integer DEFAULT 10) RETURNS TABLE(author character varying, book_count bigint, similarity_score real, match_type text)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: api_fast_author_phonetic_search_v2(text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_fast_author_phonetic_search_v2(author_query text, search_limit integer DEFAULT 10) RETURNS TABLE(author character varying, book_count bigint, similarity_score real, match_type text)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: api_fast_hybrid_search(text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_fast_hybrid_search(p_query text, p_limit integer DEFAULT 20) RETURNS TABLE(chunk_id character varying, book_id integer, content text, title character varying, author character varying, combined_score real, text_rank real, vector_similarity real, search_type text, execution_time_ms integer)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: api_find_book_by_title_match(text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_find_book_by_title_match(p_title_fragment text, p_author_fragment text DEFAULT NULL::text) RETURNS json
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_books JSON;
BEGIN
    SELECT json_agg(
        json_build_object(
            ...
            'title', b.title,
            'author', b.author,
            'has_calibre_link', (cb.id IS NOT NULL)
        )
    ) INTO v_books
    FROM books b
    LEFT JOIN calibre_books cb ON b.book_id = cb.postgres_book_id
    WHERE b.title ILIKE '%' || p_title_fragment || '%'
    AND (p_author_fragment IS NULL OR b.author ILIKE '%' || p_author_fragment || '%')
    ORDER BY 
        CASE WHEN cb.id IS NOT NULL THEN 1 ELSE 0 END DESC,  -- Prioritize unlinked books
        similarity(b.title, p_title_fragment) DESC
    LIMIT 10;
    
    RETURN json_build_object(
        'success', true,
        'matches', COALESCE(v_books, '[]'::json)
    );
...
--
-- Name: FUNCTION api_find_book_by_title_match(p_title_fragment text, p_author_fragment text); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.api_find_book_by_title_match(p_title_fragment text, p_author_fragment text) IS 'Finds PostgreSQL books by title matching for migration';
...
--
-- Name: api_get_random_passage(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_get_random_passage(p_book_id integer DEFAULT NULL::integer) RETURNS TABLE(book_id integer, title text, author text, chunk_id text, content text, chapter_number integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    IF p_book_id IS NULL THEN
...
--
-- Name: api_granular_semantic_search(text, text[], integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_granular_semantic_search(p_query text, p_chunk_types text[] DEFAULT ARRAY['sentence'::text, 'paragraph'::text, 'section'::text], p_limit integer DEFAULT 50) RETURNS TABLE(chunk_id character varying, book_id integer, title character varying, author character varying, content text, chunk_type character varying, similarity real, parent_chunk_id character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: FUNCTION api_granular_semantic_search(p_query text, p_chunk_types text[], p_limit integer); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.api_granular_semantic_search(p_query text, p_chunk_types text[], p_limit integer) IS 'Dr. Sarah Chen: Semantic search for granular chunks - requires embeddings';
...
--
-- Name: api_phonetic_search_ultra_fast_local(text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_phonetic_search_ultra_fast_local(search_query text, search_limit integer DEFAULT 5) RETURNS TABLE(chunk_id character varying, content_preview text, title character varying, author character varying, book_id integer, phonetic_score real, match_type text)
    LANGUAGE plpgsql
    AS $$
DECLARE
    query_soundex text;
...
--
-- Name: api_preprocess_semantic_chunks(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_preprocess_semantic_chunks(p_batch_size integer DEFAULT 1000) RETURNS TABLE(processed_count integer, total_phrases_found integer, processing_time_ms integer, status_message text)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: api_semantic_phrase_search(text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_semantic_phrase_search(p_query text, p_limit integer DEFAULT 50) RETURNS TABLE(chunk_id character varying, content text, title character varying, author character varying, semantic_score real, match_type text, phrase_matches text[])
    LANGUAGE plpgsql
    AS $$
DECLARE
    normalized_query TEXT;
...
CREATE FUNCTION public.api_semantic_phrase_search_optimized(p_query text, p_limit integer DEFAULT 50) RETURNS TABLE(chunk_id character varying, content text, title character varying, author character varying, semantic_score real, match_type text, phrase_matches text[])
    LANGUAGE plpgsql
    AS $$
DECLARE
    normalized_query TEXT;
...
BEGIN
    ...
    -- TIER 1: Check compound concepts first (fastest)
    RETURN QUERY 
    SELECT c.chunk_id, c.content, b.title, b.author,
           1.0::REAL as score,
           'compound_concept'::TEXT as match_type,
           ARRAY[cc.full_phrase]::TEXT[] as phrases
    FROM chunks c 
    JOIN books b ON c.book_id = b.book_id
    JOIN compound_concepts cc ON c.content ILIKE '%' || cc.full_phrase || '%'
    WHERE LOWER(cc.full_phrase) = normalized_query
    ORDER BY cc.search_priority, c.chunk_id
    LIMIT p_limit;
    
    GET DIAGNOSTICS result_count = ROW_COUNT;
    
    -- TIER 2: If no compound matches, try enhanced full-text search
    IF result_count = 0 THEN
        RETURN QUERY 
        SELECT c.chunk_id, c.content, b.title, b.author,
               ts_rank(c.search_vector, plainto_tsquery('english', normalized_query)) as score,
    ...
    -- TIER 3: Final fallback to basic content search (limited scope)
    IF result_count = 0 THEN
        RETURN QUERY 
        SELECT c.chunk_id, c.content, b.title, b.author,
               0.5::REAL as score,
        ...
        WHERE c.content ILIKE '%' || p_query || '%'
        ORDER BY LENGTH(c.content), c.chunk_id
        LIMIT LEAST(p_limit, 100);  -- Limit fallback results
    END IF;
...
--
-- Name: api_semantic_search_stats(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.api_semantic_search_stats() RETURNS TABLE(total_phrases integer, total_compound_concepts integer, total_chunk_phrase_links integer, avg_phrases_per_chunk real, last_preprocessing_run timestamp without time zone)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY SELECT
...
CREATE FUNCTION public.api_shortcuts_search_titles(p_term text, p_limit integer DEFAULT 50) RETURNS text[]
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_titles TEXT[];
...
--
-- Name: calculate_text_similarity(text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.calculate_text_similarity(text1 text, text2 text) RETURNS double precision
...
--
-- Name: calibre_similarity_score(text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.calibre_similarity_score(text1 text, text2 text) RETURNS double precision
    LANGUAGE plpgsql IMMUTABLE
    AS $$
DECLARE
    clean1 TEXT;
...
--
-- Name: chen_find_conceptual_bridges(text, text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.chen_find_conceptual_bridges(p_domain1 text, p_domain2 text, p_limit integer DEFAULT 15) RETURNS TABLE(chunk_id character varying, title character varying, content text, bridge_strength real, bridge_type text)
    LANGUAGE plpgsql
    AS $$
             BEGIN
                 RETURN QUERY
...
--
-- Name: confidence_weighted_similarity_search(jsonb, numeric, numeric, integer, character varying); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.confidence_weighted_similarity_search(p_query_embedding jsonb, p_similarity_threshold numeric DEFAULT 0.3, p_confidence_weight numeric DEFAULT 0.25, p_limit integer DEFAULT 20, p_model_filter character varying DEFAULT NULL::character varying) RETURNS TABLE(chunk_id character varying, book_id integer, embedding_model character varying, base_similarity numeric, confidence_score numeric, weighted_score numeric, title character varying, content text)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: FUNCTION confidence_weighted_similarity_search(p_query_embedding jsonb, p_similarity_threshold numeric, p_confidence_weight numeric, p_limit integer, p_model_filter character varying); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.confidence_weighted_similarity_search(p_query_embedding jsonb, p_similarity_threshold numeric, p_confidence_weight numeric, p_limit integer, p_model_filter character varying) IS 'Phase 1 API: Confidence-weighted search with 25% reliability boost';


--
-- Name: cross_book_semantic_discovery(text, double precision, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.cross_book_semantic_discovery(source_book_title text, similarity_threshold double precision DEFAULT 0.7, max_results integer DEFAULT 10) RETURNS TABLE(similar_book_title character varying, similar_author character varying, similar_genre character varying, avg_similarity double precision, matching_chunks integer, sample_content text)
    LANGUAGE plpgsql
    AS $$
DECLARE
    source_book_id int;
...
--
-- Name: emergency_backup_existing_embeddings(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.emergency_backup_existing_embeddings() RETURNS TABLE(chunks_with_embeddings integer, backup_table_created boolean, backup_record_count integer, success boolean, message text)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: emergency_migrate_embeddings_to_chunks(integer, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.emergency_migrate_embeddings_to_chunks(batch_size integer DEFAULT 1000, dry_run boolean DEFAULT false) RETURNS TABLE(total_candidates integer, migrated_count integer, conflict_count integer, orphaned_count integer, success boolean, message text, processing_time_seconds numeric)
    LANGUAGE plpgsql
    AS $$
DECLARE
    start_time TIMESTAMP;
...
--
-- Name: extended_semantic_match_score(text, text[], real[], real); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.extended_semantic_match_score(p_content text, p_query_components text[], p_component_weights real[], p_complexity_score real) RETURNS real
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: fast_jsonb_cosine_similarity(jsonb, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fast_jsonb_cosine_similarity(embedding1 jsonb, embedding2 jsonb) RETURNS double precision
    LANGUAGE plpgsql IMMUTABLE
    AS $$
DECLARE
    vec1 FLOAT[];
...
--
-- Name: FUNCTION fast_jsonb_cosine_similarity(embedding1 jsonb, embedding2 jsonb); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.fast_jsonb_cosine_similarity(embedding1 jsonb, embedding2 jsonb) IS 'Optimized JSONB cosine similarity - 2-5x faster than naive approaches';


--
-- Name: fast_vector_similarity_search(public.vector, character varying, integer, double precision); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fast_vector_similarity_search(p_query_vector public.vector, p_embedding_model character varying, p_limit integer DEFAULT 20, p_similarity_threshold double precision DEFAULT 0.3) RETURNS TABLE(chunk_id character varying, book_id integer, similarity_score double precision, title character varying, content text)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: FUNCTION fast_vector_similarity_search(p_query_vector public.vector, p_embedding_model character varying, p_limit integer, p_similarity_threshold double precision); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.fast_vector_similarity_search(p_query_vector public.vector, p_embedding_model character varying, p_limit integer, p_similarity_threshold double precision) IS 'Optimized vector search using HNSW indexes - 10-50x faster than JSONB';
...
--
-- Name: parse_extended_semantic_query(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.parse_extended_semantic_query(p_query text) RETURNS TABLE(word_count integer, complexity_score real, component_phrases text[], importance_weights real[], stop_words_removed text)
    LANGUAGE plpgsql
    AS $$
DECLARE
    words TEXT[];
...
--
-- Name: secure_vector_similarity_search(public.vector, double precision, integer, double precision); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.secure_vector_similarity_search(p_query_vector public.vector, p_confidence_weight double precision DEFAULT 0.25, p_limit integer DEFAULT 20, p_similarity_threshold double precision DEFAULT 0.0) RETURNS TABLE(chunk_id text, book_id integer, title text, content text, base_similarity double precision, confidence_score double precision, weighted_score double precision)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
        BEGIN
            -- Validate parameters
...
--
-- Name: semantic_phrase_match(text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.semantic_phrase_match(content text, query text) RETURNS real
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: semantic_phrase_score(text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.semantic_phrase_score(content text, query text) RETURNS real
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: semantic_search_chunks(text, integer, double precision); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: semantic_similarity_search(double precision[], double precision, integer, text[]); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.semantic_similarity_search(query_embedding double precision[], similarity_threshold double precision DEFAULT 0.7, max_results integer DEFAULT 20, target_genres text[] DEFAULT NULL::text[]) RETURNS TABLE(chunk_id character varying, book_id integer, title character varying, author character varying, genre character varying, content text, similarity_score double precision, chapter_number integer, word_count integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: FUNCTION semantic_similarity_search(query_embedding double precision[], similarity_threshold double precision, max_results integer, target_genres text[]); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.semantic_similarity_search(query_embedding double precision[], similarity_threshold double precision, max_results integer, target_genres text[]) IS 'Vector-first search function utilizing HNSW indexes for <50ms response times';


--
-- Name: semantic_similarity_search_v2(public.vector, double precision, integer, text[]); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.semantic_similarity_search_v2(query_embedding public.vector, similarity_threshold double precision DEFAULT 0.7, max_results integer DEFAULT 20, target_genres text[] DEFAULT NULL::text[]) RETURNS TABLE(chunk_id character varying, book_id integer, title character varying, author character varying, genre character varying, content text, similarity_score double precision, chapter_number integer, word_count integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: FUNCTION semantic_similarity_search_v2(query_embedding public.vector, similarity_threshold double precision, max_results integer, target_genres text[]); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.semantic_similarity_search_v2(query_embedding public.vector, similarity_threshold double precision, max_results integer, target_genres text[]) IS 'Optimized vector search using HNSW indexes - expected <50ms response time';
...
--
-- Name: test_extended_semantic_search(text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.test_extended_semantic_search(p_query text, p_limit integer DEFAULT 3) RETURNS TABLE(chunk_id character varying, semantic_score real, match_type text, execution_time_ms integer)
    LANGUAGE plpgsql
    AS $$
DECLARE
    start_time TIMESTAMP := clock_timestamp();
...
--
-- Name: vector_similarity_classification(integer, double precision); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.vector_similarity_classification(target_book_id integer, similarity_threshold double precision DEFAULT 0.75) RETURNS TABLE(book_id integer, similar_books jsonb, predicted_subject character varying, confidence_score double precision, method character varying)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: agent_auto_save_logs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.agent_auto_save_logs (
...
--
-- Name: agent_auto_save_logs_log_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.agent_auto_save_logs_log_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: agent_auto_save_logs_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.agent_auto_save_logs_log_id_seq OWNED BY public.agent_auto_save_logs.log_id;


--
-- Name: agent_coffee_states; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.agent_coffee_states (
    coffee_id integer NOT NULL,
    agent_id integer NOT NULL,
    coffee_given_at timestamp without time zone NOT NULL,
    boost_until timestamp without time zone NOT NULL,
    ...
    existence_level character varying(20) DEFAULT 'HYPERACTIVE'::character varying,
...
--
-- Name: TABLE agent_coffee_states; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.agent_coffee_states IS 'Coffee boost tracking for temporal existence experiments';


--
-- Name: agent_coffee_states_coffee_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.agent_coffee_states_coffee_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: agent_coffee_states_coffee_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.agent_coffee_states_coffee_id_seq OWNED BY public.agent_coffee_states.coffee_id;


--
-- Name: agent_config_history; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: agent_config_history_history_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.agent_config_history_history_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: agent_config_history_history_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.agent_config_history_history_id_seq OWNED BY public.agent_config_history.history_id;
...
CREATE TABLE public.agent_configurations (
    ...
    created_by character varying(100) DEFAULT 'Dr. Marcus Liu (刘明华)'::character varying
);


--
-- Name: agent_configurations_config_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.agent_configurations_config_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: agent_configurations_config_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.agent_configurations_config_id_seq OWNED BY public.agent_configurations.config_id;
...
--
-- Name: TABLE agent_interactions; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.agent_interactions IS 'Core performance tracking with cultural scoring';


--
-- Name: agent_interactions_interaction_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.agent_interactions_interaction_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: agent_interactions_interaction_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.agent_interactions_interaction_id_seq OWNED BY public.agent_interactions.interaction_id;


--
-- Name: agent_learning_history; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.agent_learning_history (
...
--
-- Name: agent_learning_history_learning_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.agent_learning_history_learning_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: agent_learning_history_learning_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.agent_learning_history_learning_id_seq OWNED BY public.agent_learning_history.learning_id;


--
-- Name: agent_memory_checkpoints; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.agent_memory_checkpoints (
    checkpoint_id uuid DEFAULT gen_random_uuid() NOT NULL,
    agent_name character varying(100) NOT NULL,
    session_id uuid NOT NULL,
    memory_data jsonb NOT NULL,
    token_count integer DEFAULT 0,
    checkpoint_type character varying(20) DEFAULT 'auto_save'::character varying,
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now()
);
...
--
-- Name: agent_memory_optimization_metrics; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.agent_memory_optimization_metrics (
    metric_id integer NOT NULL,
    agent_name character varying(100) NOT NULL,
    date_measured date DEFAULT CURRENT_DATE,
    total_checkpoints integer,
    avg_checkpoint_size_kb real,
    memory_retrieval_time_ms real,
    checkpoint_success_rate real,
    optimization_recommendations jsonb,
    measured_by character varying(100) DEFAULT 'Dr. Marcus Liu (刘明华)'::character varying
);


--
-- Name: agent_memory_optimization_metrics_metric_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.agent_memory_optimization_metrics_metric_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: agent_memory_optimization_metrics_metric_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.agent_memory_optimization_metrics_metric_id_seq OWNED BY public.agent_memory_optimization_metrics.metric_id;
...
--
-- Name: agent_token_usage_tracking; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.agent_token_usage_tracking (
...
--
-- Name: agent_token_usage_tracking_usage_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.agent_token_usage_tracking_usage_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: agent_token_usage_tracking_usage_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.agent_token_usage_tracking_usage_id_seq OWNED BY public.agent_token_usage_tracking.usage_id;
...
--
-- Name: temporal_embeddings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.temporal_embeddings (
    chunk_id character varying(255) NOT NULL,
    book_id integer,
    chunk_level character varying(20),
    embedding public.vector(1536),
...
--
-- Name: topical_embeddings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.topical_embeddings (
    chunk_id character varying(255) NOT NULL,
    book_id integer,
    chunk_level character varying(20),
    embedding public.vector(1536),
...
--
-- Name: training_progress_progress_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.training_progress_progress_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: training_progress_progress_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.training_progress_progress_id_seq OWNED BY public.training_progress.progress_id;
...
COMMENT ON TABLE public.user_requests IS 'User interaction tracking for satisfaction analysis';


--
-- Name: user_requests_request_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.user_requests_request_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: user_requests_request_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.user_requests_request_id_seq OWNED BY public.user_requests.request_id;
 ...
 SELECT a.agent_name,
    ...
    (((count(
        CASE
            WHEN ai.success THEN 1
            ELSE NULL::integer
        END))::real / (NULLIF(count(ai.interaction_id), 0))::double precision) * (100)::double precision) AS success_rate,
    avg(ai.duration_ms) AS avg_duration_ms,
    avg(ai.performance_score) AS avg_performance_score,
    max(ai."timestamp") AS last_active,
        CASE
            WHEN (count(ai.interaction_id) < 5) THEN 'Low Activity'::text
            WHEN (((count(
            CASE
                WHEN ai.success THEN 1
                ELSE NULL::integer
            END))::real / (NULLIF(count(ai.interaction_id), 0))::double precision) < (0.7)::double precision) THEN 'Poor Performance'::text
            WHEN (avg(ai.duration_ms) > (5000)::double precision) THEN 'Slow Response'::text
            ELSE 'Satisfactory'::text
        END AS status_assessment
   FROM (public.agents a
     LEFT JOIN public.agent_interactions ai ON ((a.agent_id = ai.agent_id)))
  ...
  ORDER BY (((count(
        CASE
            WHEN ai.success THEN 1
            ELSE NULL::integer
        END))::real / (NULLIF(count(ai.interaction_id), 0))::double precision) * (100)::double precision) DESC, (avg(ai.performance_score)) DESC;
...
--
-- Name: v_coffee_analytics; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_coffee_analytics AS
 SELECT a.agent_name,
    count(acs.coffee_id) AS total_coffee_consumed,
    avg((EXTRACT(epoch FROM (acs.boost_until - acs.coffee_given_at)) / (3600)::numeric)) AS avg_boost_hours,
    max(acs.coffee_given_at) AS last_coffee,
    sum(
        CASE
            WHEN ((acs.status)::text = 'caffeinated'::text) THEN 1
            ELSE 0
        END) AS currently_caffeinated,
    avg(acs.frequency_multiplier) AS avg_frequency_boost
   FROM (public.agents a
     LEFT JOIN public.agent_coffee_states acs ON ((a.agent_id = acs.agent_id)))
  GROUP BY a.agent_id, a.agent_name
  ORDER BY (count(acs.coffee_id)) DESC;
...
CREATE VIEW public.v_daily_activity AS
 SELECT date_trunc('day'::text, ai."timestamp") AS activity_date,
    ...
    (((count(
        CASE
            WHEN ai.success THEN 1
            ELSE NULL::integer
        END))::real / (NULLIF(count(ai.interaction_id), 0))::double precision) * (100)::double precision) AS daily_success_rate
   FROM public.agent_interactions ai
  GROUP BY (date_trunc('day'::text, ai."timestamp"))
  ORDER BY (date_trunc('day'::text, ai."timestamp")) DESC;
...
--
-- Name: v_workforce_grades; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_workforce_grades AS
 SELECT ap.agent_name,
    ap.success_rate,
    ap.avg_performance_score,
    ap.total_interactions,
        CASE
            WHEN ((ap.success_rate >= (95)::double precision) AND (ap.avg_performance_score >= (0.9)::double precision)) THEN 'A'::text
            WHEN ((ap.success_rate >= (85)::double precision) AND (ap.avg_performance_score >= (0.8)::double precision)) THEN 'B'::text
            WHEN ((ap.success_rate >= (75)::double precision) AND (ap.avg_performance_score >= (0.7)::double precision)) THEN 'C'::text
            WHEN ((ap.success_rate >= (60)::double precision) AND (ap.avg_performance_score >= (0.6)::double precision)) THEN 'D'::text
            ELSE 'F'::text
        END AS grade,
        CASE
            WHEN (ap.success_rate >= (90)::double precision) THEN '勤奋工作'::text
            WHEN (ap.success_rate >= (75)::double precision) THEN '需要改进'::text
            ELSE '急需培训'::text
        END AS cultural_assessment
   FROM public.v_agent_performance ap;
...
--
-- Name: weekly_agent_targets; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.weekly_agent_targets (
...
--
-- Name: weekly_agent_targets_target_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.weekly_agent_targets_target_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: weekly_agent_targets_target_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.weekly_agent_targets_target_id_seq OWNED BY public.weekly_agent_targets.target_id;


--
-- Name: weekly_performance_evaluations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.weekly_performance_evaluations (
    evaluation_id integer NOT NULL,
    agent_name character varying(100) NOT NULL,
    week_start date NOT NULL,
    evaluation_data jsonb NOT NULL,
    evaluator character varying(100) DEFAULT 'hr_agent_linda'::character varying,
    evaluation_date timestamp without time zone DEFAULT now()
);


--
-- Name: weekly_performance_evaluations_evaluation_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.weekly_performance_evaluations_evaluation_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: weekly_performance_evaluations_evaluation_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.weekly_performance_evaluations_evaluation_id_seq OWNED BY public.weekly_performance_evaluations.evaluation_id;
...
--
-- Name: agent_auto_save_logs log_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_auto_save_logs ALTER COLUMN log_id SET DEFAULT nextval('public.agent_auto_save_logs_log_id_seq'::regclass);


--
-- Name: agent_coffee_states coffee_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_coffee_states ALTER COLUMN coffee_id SET DEFAULT nextval('public.agent_coffee_states_coffee_id_seq'::regclass);


--
-- Name: agent_config_history history_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_config_history ALTER COLUMN history_id SET DEFAULT nextval('public.agent_config_history_history_id_seq'::regclass);


--
-- Name: agent_configurations config_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_configurations ALTER COLUMN config_id SET DEFAULT nextval('public.agent_configurations_config_id_seq'::regclass);


--
-- Name: agent_interactions interaction_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_interactions ALTER COLUMN interaction_id SET DEFAULT nextval('public.agent_interactions_interaction_id_seq'::regclass);


--
-- Name: agent_learning_history learning_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_learning_history ALTER COLUMN learning_id SET DEFAULT nextval('public.agent_learning_history_learning_id_seq'::regclass);


--
-- Name: agent_memory_optimization_metrics metric_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_memory_optimization_metrics ALTER COLUMN metric_id SET DEFAULT nextval('public.agent_memory_optimization_metrics_metric_id_seq'::regclass);
...
--
-- Name: agent_token_usage_tracking usage_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_token_usage_tracking ALTER COLUMN usage_id SET DEFAULT nextval('public.agent_token_usage_tracking_usage_id_seq'::regclass);
...
--
-- Name: training_progress progress_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.training_progress ALTER COLUMN progress_id SET DEFAULT nextval('public.training_progress_progress_id_seq'::regclass);


--
-- Name: user_requests request_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_requests ALTER COLUMN request_id SET DEFAULT nextval('public.user_requests_request_id_seq'::regclass);


--
-- Name: weekly_agent_targets target_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.weekly_agent_targets ALTER COLUMN target_id SET DEFAULT nextval('public.weekly_agent_targets_target_id_seq'::regclass);


--
-- Name: weekly_performance_evaluations evaluation_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.weekly_performance_evaluations ALTER COLUMN evaluation_id SET DEFAULT nextval('public.weekly_performance_evaluations_evaluation_id_seq'::regclass);


--
-- Name: task_schedule task_schedule_pkey; Type: CONSTRAINT; Schema: hr_automation; Owner: -
--

ALTER TABLE ONLY hr_automation.task_schedule
    ADD CONSTRAINT task_schedule_pkey PRIMARY KEY (task_id);


--
-- Name: task_schedule task_schedule_task_name_key; Type: CONSTRAINT; Schema: hr_automation; Owner: -
--

ALTER TABLE ONLY hr_automation.task_schedule
    ADD CONSTRAINT task_schedule_task_name_key UNIQUE (task_name);


--
-- Name: agent_auto_save_logs agent_auto_save_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_auto_save_logs
    ADD CONSTRAINT agent_auto_save_logs_pkey PRIMARY KEY (log_id);


--
-- Name: agent_coffee_states agent_coffee_states_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_coffee_states
    ADD CONSTRAINT agent_coffee_states_pkey PRIMARY KEY (coffee_id);


--
-- Name: agent_config_history agent_config_history_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_config_history
    ADD CONSTRAINT agent_config_history_pkey PRIMARY KEY (history_id);


--
-- Name: agent_configurations agent_configurations_agent_name_config_category_config_vers_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_configurations
    ADD CONSTRAINT agent_configurations_agent_name_config_category_config_vers_key UNIQUE (agent_name, config_category, config_version);
...
ALTER TABLE ONLY public.agent_interactions
    ADD CONSTRAINT agent_interactions_pkey PRIMARY KEY (interaction_id);


--
-- Name: agent_learning_history agent_learning_history_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_learning_history
    ADD CONSTRAINT agent_learning_history_pkey PRIMARY KEY (learning_id);


--
-- Name: agent_memory_checkpoints agent_memory_checkpoints_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_memory_checkpoints
    ADD CONSTRAINT agent_memory_checkpoints_pkey PRIMARY KEY (checkpoint_id);


--
-- Name: agent_memory_optimization_metrics agent_memory_optimization_metrics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_memory_optimization_metrics
    ADD CONSTRAINT agent_memory_optimization_metrics_pkey PRIMARY KEY (metric_id);
...
ALTER TABLE ONLY public.agent_posts
    ADD CONSTRAINT agent_posts_pkey PRIMARY KEY (post_id);


--
-- Name: agent_social_connections agent_social_connections_agent_id_connected_agent_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_social_connections
    ADD CONSTRAINT agent_social_connections_agent_id_connected_agent_id_key UNIQUE (agent_id, connected_agent_id);


--
-- Name: agent_social_connections agent_social_connections_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_social_connections
    ADD CONSTRAINT agent_social_connections_pkey PRIMARY KEY (connection_id);


--
-- Name: agent_token_usage_tracking agent_token_usage_tracking_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_token_usage_tracking
    ADD CONSTRAINT agent_token_usage_tracking_pkey PRIMARY KEY (usage_id);
...
--
-- Name: api_performance_log api_performance_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.api_performance_log
    ADD CONSTRAINT api_performance_log_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.api_rate_limits
    ADD CONSTRAINT api_rate_limits_pkey PRIMARY KEY (client_ip);
...
--
-- Name: book_contents book_contents_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.book_contents
    ADD CONSTRAINT book_contents_pkey PRIMARY KEY (book_id);
...
--
-- Name: calibre_books calibre_books_calibre_id_idx; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calibre_books
    ADD CONSTRAINT calibre_books_calibre_id_idx UNIQUE (calibre_id);


--
-- Name: calibre_books calibre_books_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calibre_books
    ADD CONSTRAINT calibre_books_pkey PRIMARY KEY (id);


--
-- Name: calibre_books calibre_books_postgres_book_id_idx; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calibre_books
    ADD CONSTRAINT calibre_books_postgres_book_id_idx UNIQUE (postgres_book_id);


--
-- Name: calibre_file_sync calibre_file_sync_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calibre_file_sync
    ADD CONSTRAINT calibre_file_sync_pkey PRIMARY KEY (id);


--
-- Name: calibre_library_sync calibre_library_sync_book_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calibre_library_sync
    ADD CONSTRAINT calibre_library_sync_book_id_key UNIQUE (book_id);


--
-- Name: calibre_library_sync calibre_library_sync_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calibre_library_sync
    ADD CONSTRAINT calibre_library_sync_pkey PRIMARY KEY (sync_id);


--
-- Name: calibre_metadata_conflicts calibre_metadata_conflicts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calibre_metadata_conflicts
    ADD CONSTRAINT calibre_metadata_conflicts_pkey PRIMARY KEY (conflict_id);
...
--
-- Name: chunk_embeddings chunk_embeddings_unique_chunk_model; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_embeddings
    ADD CONSTRAINT chunk_embeddings_unique_chunk_model UNIQUE (chunk_id, embedding_model);
...
ALTER TABLE ONLY public.chunk_entities
    ADD CONSTRAINT chunk_entities_pkey PRIMARY KEY (entity_id);


--
-- Name: chunk_extended_semantics chunk_extended_semantics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_extended_semantics
    ADD CONSTRAINT chunk_extended_semantics_pkey PRIMARY KEY (chunk_id, concept_id, match_type);


--
-- Name: chunk_outlines chunk_outlines_chunk_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_outlines
    ADD CONSTRAINT chunk_outlines_chunk_id_key UNIQUE (chunk_id);


--
-- Name: chunk_outlines chunk_outlines_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_outlines
    ADD CONSTRAINT chunk_outlines_pkey PRIMARY KEY (id);


--
-- Name: chunk_processed_terms chunk_processed_terms_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_processed_terms
    ADD CONSTRAINT chunk_processed_terms_pkey PRIMARY KEY (chunk_id);


--
-- Name: chunk_semantic_phrases chunk_semantic_phrases_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_semantic_phrases
    ADD CONSTRAINT chunk_semantic_phrases_pkey PRIMARY KEY (chunk_id, phrase_id);


--
-- Name: chunk_summaries chunk_summaries_chunk_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_summaries
    ADD CONSTRAINT chunk_summaries_chunk_id_key UNIQUE (chunk_id);
...
ALTER TABLE ONLY public.chunk_summaries
    ADD CONSTRAINT chunk_summaries_pkey PRIMARY KEY (summary_id);
...
--
-- Name: compound_concepts compound_concepts_full_phrase_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.compound_concepts
    ADD CONSTRAINT compound_concepts_full_phrase_key UNIQUE (full_phrase);


--
-- Name: compound_concepts compound_concepts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.compound_concepts
    ADD CONSTRAINT compound_concepts_pkey PRIMARY KEY (concept_id);


--
-- Name: content_classifications content_classifications_chunk_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.content_classifications
    ADD CONSTRAINT content_classifications_chunk_id_key UNIQUE (chunk_id);


--
-- Name: content_classifications content_classifications_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.content_classifications
    ADD CONSTRAINT content_classifications_pkey PRIMARY KEY (classification_id);


--
-- Name: cross_training_plans cross_training_plans_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cross_training_plans
    ADD CONSTRAINT cross_training_plans_pkey PRIMARY KEY (plan_id);


--
-- Name: cross_training_progress cross_training_progress_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cross_training_progress
    ADD CONSTRAINT cross_training_progress_pkey PRIMARY KEY (progress_id);


--
-- Name: dr_elena_description_enhancement_log dr_elena_description_enhancement_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dr_elena_description_enhancement_log
    ADD CONSTRAINT dr_elena_description_enhancement_log_pkey PRIMARY KEY (log_id);


--
-- Name: dr_elena_epub_migration_log dr_elena_epub_migration_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dr_elena_epub_migration_log
    ADD CONSTRAINT dr_elena_epub_migration_log_pkey PRIMARY KEY (migration_id);


--
-- Name: embedding_queue embedding_queue_chunk_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.embedding_queue
    ADD CONSTRAINT embedding_queue_chunk_id_key UNIQUE (chunk_id);
...
--
-- Name: embedding_routing_log embedding_routing_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.embedding_routing_log
    ADD CONSTRAINT embedding_routing_log_pkey PRIMARY KEY (routing_id);


--
-- Name: emergency_cross_training emergency_cross_training_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.emergency_cross_training
    ADD CONSTRAINT emergency_cross_training_pkey PRIMARY KEY (training_id);


--
-- Name: extended_semantic_concepts extended_semantic_concepts_full_phrase_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.extended_semantic_concepts
    ADD CONSTRAINT extended_semantic_concepts_full_phrase_key UNIQUE (full_phrase);


--
-- Name: extended_semantic_concepts extended_semantic_concepts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.extended_semantic_concepts
    ADD CONSTRAINT extended_semantic_concepts_pkey PRIMARY KEY (concept_id);


--
-- Name: factual_embeddings factual_embeddings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.factual_embeddings
    ADD CONSTRAINT factual_embeddings_pkey PRIMARY KEY (chunk_id);


--
-- Name: global_agent_settings global_agent_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.global_agent_settings
    ADD CONSTRAINT global_agent_settings_pkey PRIMARY KEY (setting_id);


--
-- Name: global_agent_settings global_agent_settings_setting_category_setting_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.global_agent_settings
    ADD CONSTRAINT global_agent_settings_setting_category_setting_key_key UNIQUE (setting_category, setting_key);


--
-- Name: hr_daily_reports hr_daily_reports_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hr_daily_reports
    ADD CONSTRAINT hr_daily_reports_pkey PRIMARY KEY (report_id);


--
-- Name: library_health_checks library_health_checks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.library_health_checks
    ADD CONSTRAINT library_health_checks_pkey PRIMARY KEY (check_id);


--
-- Name: mentorship_progress mentorship_progress_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mentorship_progress
    ADD CONSTRAINT mentorship_progress_pkey PRIMARY KEY (progress_id);


--
-- Name: mentorship_relationships mentorship_relationships_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mentorship_relationships
    ADD CONSTRAINT mentorship_relationships_pkey PRIMARY KEY (relationship_id);


--
-- Name: outline_vectors outline_vectors_book_title_chapter_number_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.outline_vectors
    ADD CONSTRAINT outline_vectors_book_title_chapter_number_key UNIQUE (book_title, chapter_number);


--
-- Name: outline_vectors outline_vectors_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.outline_vectors
    ADD CONSTRAINT outline_vectors_pkey PRIMARY KEY (id);


--
-- Name: processing_log processing_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: query_embeddings_cache query_embeddings_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.query_embeddings_cache
    ADD CONSTRAINT query_embeddings_cache_pkey PRIMARY KEY (query_hash);


--
-- Name: quote_search_cache quote_search_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.quote_search_cache
    ADD CONSTRAINT quote_search_cache_pkey PRIMARY KEY (cache_id);


--
-- Name: quote_search_cache quote_search_cache_search_hash_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.quote_search_cache
    ADD CONSTRAINT quote_search_cache_search_hash_key UNIQUE (search_hash);


--
-- Name: rss_generation_log rss_generation_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rss_generation_log
    ADD CONSTRAINT rss_generation_log_pkey PRIMARY KEY (generation_id);
...
--
-- Name: search_performance_metrics search_performance_metrics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.search_performance_metrics
    ADD CONSTRAINT search_performance_metrics_pkey PRIMARY KEY (metric_id);


--
-- Name: semantic_chunks semantic_chunks_book_id_chunk_level_chunk_index_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.semantic_chunks
    ADD CONSTRAINT semantic_chunks_book_id_chunk_level_chunk_index_key UNIQUE (book_id, chunk_level, chunk_index);


--
-- Name: semantic_chunks semantic_chunks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.semantic_chunks
    ADD CONSTRAINT semantic_chunks_pkey PRIMARY KEY (chunk_id);
...
ALTER TABLE ONLY public.semantic_embeddings
    ADD CONSTRAINT semantic_embeddings_pkey PRIMARY KEY (chunk_id);


--
-- Name: semantic_ngrams semantic_ngrams_ngram_text_ngram_size_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.semantic_ngrams
    ADD CONSTRAINT semantic_ngrams_ngram_text_ngram_size_key UNIQUE (ngram_text, ngram_size);


--
-- Name: semantic_ngrams semantic_ngrams_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.semantic_ngrams
    ADD CONSTRAINT semantic_ngrams_pkey PRIMARY KEY (ngram_id);


--
-- Name: semantic_phrases semantic_phrases_normalized_form_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.semantic_phrases
    ADD CONSTRAINT semantic_phrases_normalized_form_key UNIQUE (normalized_form);


--
-- Name: semantic_phrases semantic_phrases_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.semantic_phrases
    ADD CONSTRAINT semantic_phrases_pkey PRIMARY KEY (phrase_id);


--
-- Name: semantic_query_performance semantic_query_performance_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.semantic_query_performance
    ADD CONSTRAINT semantic_query_performance_pkey PRIMARY KEY (query_id);


--
-- Name: stylistic_embeddings stylistic_embeddings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.stylistic_embeddings
    ADD CONSTRAINT stylistic_embeddings_pkey PRIMARY KEY (chunk_id);


--
-- Name: temporal_embeddings temporal_embeddings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.temporal_embeddings
    ADD CONSTRAINT temporal_embeddings_pkey PRIMARY KEY (chunk_id);


--
-- Name: topical_embeddings topical_embeddings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.topical_embeddings
    ADD CONSTRAINT topical_embeddings_pkey PRIMARY KEY (chunk_id);
...
ALTER TABLE ONLY public.training_progress
    ADD CONSTRAINT training_progress_pkey PRIMARY KEY (progress_id);
...
--
-- Name: weekly_agent_targets weekly_agent_targets_agent_name_week_start_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.weekly_agent_targets
    ADD CONSTRAINT weekly_agent_targets_agent_name_week_start_key UNIQUE (agent_name, week_start);


--
-- Name: weekly_agent_targets weekly_agent_targets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.weekly_agent_targets
    ADD CONSTRAINT weekly_agent_targets_pkey PRIMARY KEY (target_id);


--
-- Name: weekly_performance_evaluations weekly_performance_evaluations_agent_name_week_start_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.weekly_performance_evaluations
    ADD CONSTRAINT weekly_performance_evaluations_agent_name_week_start_key UNIQUE (agent_name, week_start);


--
-- Name: weekly_performance_evaluations weekly_performance_evaluations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.weekly_performance_evaluations
    ADD CONSTRAINT weekly_performance_evaluations_pkey PRIMARY KEY (evaluation_id);


--
-- Name: chunks_outline_characters_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX chunks_outline_characters_gin ON public.chunks USING gin (outline_characters) WHERE (outline_characters IS NOT NULL);


--
-- Name: chunks_outline_mood_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX chunks_outline_mood_idx ON public.chunks USING btree (outline_mood_tone) WHERE (outline_mood_tone IS NOT NULL);


--
-- Name: chunks_outline_quality_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX chunks_outline_quality_idx ON public.chunks USING btree (outline_quality) WHERE (outline_quality IS NOT NULL);


--
-- Name: idx_agent_configs_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_configs_active ON public.agent_configurations USING btree (is_active);


--
-- Name: idx_agent_configs_name_category; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_configs_name_category ON public.agent_configurations USING btree (agent_name, config_category);


--
-- Name: idx_agent_interactions_action; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_interactions_action ON public.agent_interactions USING btree (action);


--
-- Name: idx_agent_interactions_agent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_interactions_agent ON public.agent_interactions USING btree (agent_id);


--
-- Name: idx_agent_interactions_request; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_interactions_request ON public.agent_interactions USING btree (request_id);


--
-- Name: idx_agent_interactions_success; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_interactions_success ON public.agent_interactions USING btree (success);


--
-- Name: idx_agent_interactions_timestamp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_interactions_timestamp ON public.agent_interactions USING btree ("timestamp");


--
-- Name: idx_agent_posts_agent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_posts_agent ON public.agent_posts USING btree (agent_id);


--
-- Name: idx_agent_posts_book; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_posts_book ON public.agent_posts USING btree (book_title) WHERE (book_title IS NOT NULL);


--
-- Name: idx_agent_posts_category; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_posts_category ON public.agent_posts USING btree (category);


--
-- Name: idx_agent_posts_coffee; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_posts_coffee ON public.agent_posts USING btree (coffee_boosted, existence_level);


--
-- Name: idx_agent_posts_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_posts_created ON public.agent_posts USING btree (created_at);


--
-- Name: idx_agent_posts_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_posts_type ON public.agent_posts USING btree (post_type);


--
-- Name: idx_agents_category; Type: INDEX; Schema: public; Owner: -
--
...
CREATE INDEX idx_agents_name ON public.agents USING btree (agent_name);
...
--
-- Name: idx_api_performance_log_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_api_performance_log_created_at ON public.api_performance_log USING btree (created_at);


--
-- Name: idx_api_performance_log_function_name; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_api_performance_log_function_name ON public.api_performance_log USING btree (function_name);


--
-- Name: idx_authors_name; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_authors_name ON public.authors USING btree (name);


--
-- Name: idx_autosave_logs_agent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_autosave_logs_agent ON public.agent_auto_save_logs USING btree (agent_name);


--
-- Name: idx_autosave_logs_success; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_autosave_logs_success ON public.agent_auto_save_logs USING btree (success);


--
-- Name: idx_autosave_logs_trigger; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_autosave_logs_trigger ON public.agent_auto_save_logs USING btree (trigger_type);


--
-- Name: idx_book_contents_book_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_book_contents_book_id ON public.book_contents USING btree (book_id);
...
--
-- Name: idx_books_author_trigram; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_books_author_trigram ON public.books USING gin (author public.gin_trgm_ops);


--
-- Name: idx_books_calibre_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_books_calibre_id ON public.books USING btree (calibre_id) WHERE (calibre_id IS NOT NULL);


--
-- Name: idx_books_calibre_series; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_books_calibre_series ON public.books USING btree (((metadata ->> 'calibre_series'::text)));


--
-- Name: idx_books_isbn_upper; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_books_isbn_upper ON public.books USING btree (upper(TRIM(BOTH FROM isbn))) WHERE (isbn IS NOT NULL);
...
CREATE INDEX idx_books_metadata_gin ON public.books USING gin (metadata);


--
-- Name: idx_books_metadata_source; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_books_metadata_source ON public.books USING btree (((metadata ->> 'metadata_source'::text)));


--
-- Name: idx_books_sync_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_books_sync_status ON public.books USING btree (file_sync_status) WHERE (file_sync_status = ANY (ARRAY['pending'::text, 'failed'::text]));
...
--
-- Name: idx_books_title_trigram; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_books_title_trigram ON public.books USING gin (title public.gin_trgm_ops);


--
-- Name: idx_calibre_books_calibre_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_calibre_books_calibre_id ON public.calibre_books USING btree (calibre_id);


--
-- Name: idx_calibre_books_path; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_calibre_books_path ON public.calibre_books USING btree (calibre_path);


--
-- Name: idx_calibre_books_postgres_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_calibre_books_postgres_id ON public.calibre_books USING btree (postgres_book_id);


--
-- Name: idx_calibre_books_sync_timestamp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_calibre_books_sync_timestamp ON public.calibre_books USING btree (sync_timestamp);


--
-- Name: idx_calibre_sync_book_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_calibre_sync_book_id ON public.calibre_library_sync USING btree (book_id);


--
-- Name: idx_calibre_sync_calibre_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_calibre_sync_calibre_id ON public.calibre_library_sync USING btree (calibre_book_id);


--
-- Name: idx_calibre_sync_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_calibre_sync_status ON public.calibre_library_sync USING btree (metadata_sync_status);


--
-- Name: idx_calibre_sync_timestamp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_calibre_sync_timestamp ON public.calibre_library_sync USING btree (last_sync_timestamp);


--
-- Name: idx_checkpoints_agent_session; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_checkpoints_agent_session ON public.agent_memory_checkpoints USING btree (agent_name, session_id);


--
-- Name: idx_checkpoints_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_checkpoints_created ON public.agent_memory_checkpoints USING btree (created_at);


--
-- Name: idx_checkpoints_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_checkpoints_type ON public.agent_memory_checkpoints USING btree (checkpoint_type);


--
-- Name: idx_chen_academic_search; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chen_academic_search ON public.chunks USING gin (search_vector) WHERE ((word_count > 100) AND (content IS NOT NULL));


--
-- Name: idx_chen_fast_trigram; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chen_fast_trigram ON public.chunks USING gist (content public.gist_trgm_ops) WHERE ((content IS NOT NULL) AND ((word_count >= 100) AND (word_count <= 1000)) AND ((content ~* 'philosophy|science|technology|art|literature'::text) OR (content ~* 'love|power|desire|identity|freedom'::text)));


--
-- Name: idx_chen_ultra_fast_trigram; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chen_ultra_fast_trigram ON public.chunks USING gist (content public.gist_trgm_ops) WHERE ((content IS NOT NULL) AND ((word_count >= 100) AND (word_count <= 800)) AND ((content ~* 'love|power|desire|identity|freedom|hero|magic|AI|robot|future'::text) OR (content ~* 'philosophy|science|technology|art|mathematics|biology'::text) OR (content ~* 'queer|gender|sexuality|surveillance|control|resistance'::text)));


--
-- Name: idx_chunk_embeddings_book_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_embeddings_book_id ON public.chunk_embeddings USING btree (book_id);


--
-- Name: idx_chunk_embeddings_confidence; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_embeddings_confidence ON public.chunk_embeddings USING btree (confidence_score DESC);


--
-- Name: idx_chunk_embeddings_confidence_weighted; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_embeddings_confidence_weighted ON public.chunk_embeddings USING btree (embedding_model, confidence_score DESC, book_id) WHERE (confidence_score IS NOT NULL);


--
-- Name: idx_chunk_embeddings_content_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_embeddings_content_type ON public.chunk_embeddings USING btree (content_type);


--
-- Name: idx_chunk_embeddings_hnsw; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_embeddings_hnsw ON public.chunk_embeddings USING hnsw (embedding_vector public.vector_cosine_ops) WITH (m='16', ef_construction='64');


--
-- Name: idx_chunk_embeddings_model; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_embeddings_model ON public.chunk_embeddings USING btree (embedding_model);


--
-- Name: idx_chunk_embeddings_model_optimized; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_embeddings_model_optimized ON public.chunk_embeddings USING btree (embedding_model, book_id) WHERE (embedding IS NOT NULL);


--
-- Name: idx_chunk_embeddings_security; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_embeddings_security ON public.chunk_embeddings USING btree (embedding_model, book_id) WHERE (embedding_vector IS NOT NULL);


--
-- Name: idx_chunk_embeddings_vector_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_embeddings_vector_gin ON public.chunk_embeddings USING gin (embedding);


--
-- Name: idx_chunk_embeddings_vector_hnsw; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_embeddings_vector_hnsw ON public.chunk_embeddings USING hnsw (embedding_vector public.vector_cosine_ops) WITH (m='16', ef_construction='64') WHERE ((embedding_vector IS NOT NULL) AND ((embedding_model)::text = 'nomic-embed-text'::text));


--
-- Name: idx_chunk_entities_book; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_entities_book ON public.chunk_entities USING btree (book_id);


--
-- Name: idx_chunk_entities_text_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_entities_text_gin ON public.chunk_entities USING gin (to_tsvector('english'::regconfig, (entity_text)::text));


--
-- Name: idx_chunk_entities_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_entities_type ON public.chunk_entities USING btree (entity_type);


--
-- Name: idx_chunk_extended_components; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_extended_components ON public.chunk_extended_semantics USING gin (component_matches);


--
-- Name: idx_chunk_extended_match_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_extended_match_type ON public.chunk_extended_semantics USING btree (match_type, match_strength DESC);


--
-- Name: idx_chunk_keywords_array; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_keywords_array ON public.chunk_processed_terms USING gin (processed_keywords);


--
-- Name: idx_chunk_keywords_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_keywords_gin ON public.chunk_processed_terms USING gin (keyword_tsvector);


--
-- Name: idx_chunk_semantic_phrases_count; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_semantic_phrases_count ON public.chunk_semantic_phrases USING btree (occurrence_count DESC);


--
-- Name: idx_chunk_semantic_phrases_phrase; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_semantic_phrases_phrase ON public.chunk_semantic_phrases USING btree (phrase_id);


--
-- Name: idx_chunk_semantic_phrases_strength; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_semantic_phrases_strength ON public.chunk_semantic_phrases USING btree (context_strength DESC);


--
-- Name: idx_chunk_summaries_book; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_summaries_book ON public.chunk_summaries USING btree (book_id);


--
-- Name: idx_chunk_summaries_compression; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunk_summaries_compression ON public.chunk_summaries USING btree (compression_ratio);


--
-- Name: idx_chunks_audiobook_normalized; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_audiobook_normalized ON public.chunks USING gin (to_tsvector('english'::regconfig, content_audiobook_normalized));


--
-- Name: idx_chunks_audiobook_normalized_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_audiobook_normalized_gin ON public.chunks USING gin (to_tsvector('english'::regconfig, content_audiobook_normalized));


--
-- Name: idx_chunks_audiobook_normalized_trigram; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_audiobook_normalized_trigram ON public.chunks USING gin (content_audiobook_normalized public.gin_trgm_ops);


--
-- Name: idx_chunks_book_chapter; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_book_chapter ON public.chunks USING btree (book_id, chapter_number);
...
--
-- Name: idx_chunks_book_id_start_pos; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_book_id_start_pos ON public.chunks USING btree (book_id, start_position);


--
-- Name: idx_chunks_book_performance; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_book_performance ON public.chunks USING btree (book_id, chunk_id);


--
-- Name: idx_chunks_book_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_book_type ON public.chunks USING btree (book_id, chunk_type);


--
-- Name: idx_chunks_chapter; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_chapter ON public.chunks USING btree (chapter_number);


--
-- Name: idx_chunks_chapter_discovery; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_chapter_discovery ON public.chunks USING btree (chunk_type, book_id, chunk_id) WHERE (((chunk_type)::text = 'chapter'::text) AND (word_count > 50));


--
-- Name: idx_chunks_content_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_content_gin ON public.chunks USING gin (to_tsvector('english'::regconfig, content)) WHERE (content IS NOT NULL);


--
-- Name: idx_chunks_content_gin_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_content_gin_trgm ON public.chunks USING gin (content public.gin_trgm_ops) WHERE ((content IS NOT NULL) AND (length(content) < 8000));


--
-- Name: idx_chunks_content_metaphone_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_content_metaphone_gin ON public.chunks USING gin (to_tsvector('english'::regconfig, content_metaphone));


--
-- Name: idx_chunks_content_soundex_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_content_soundex_gin ON public.chunks USING gin (to_tsvector('english'::regconfig, content_soundex));


--
-- Name: idx_chunks_content_trgm_small; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_content_trgm_small ON public.chunks USING gin (content public.gin_trgm_ops) WHERE ((content IS NOT NULL) AND ((length(content) >= 50) AND (length(content) <= 2000)));


--
-- Name: idx_chunks_content_tsvector; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_content_tsvector ON public.chunks USING gin (to_tsvector('english'::regconfig, content));


--
-- Name: idx_chunks_content_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_content_type ON public.chunks USING btree (content_type);


--
-- Name: idx_chunks_embedding_model; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_embedding_model ON public.chunks USING btree (embedding_model_used);


--
-- Name: idx_chunks_embedding_vector; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_embedding_vector ON public.chunks USING ivfflat (embedding_vector public.vector_cosine_ops) WITH (lists='100');


--
-- Name: idx_chunks_metaphone_performance; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_metaphone_performance ON public.chunks USING btree (content_metaphone) WHERE (content_metaphone IS NOT NULL);


--
-- Name: idx_chunks_metaphone_similarity; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_metaphone_similarity ON public.chunks USING gin (content_metaphone public.gin_trgm_ops) WHERE (content_metaphone IS NOT NULL);


--
-- Name: idx_chunks_mg_type_performance; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_mg_type_performance ON public.chunks USING btree (chunk_type, book_id, word_count) WHERE ((chunk_id)::text ~~ 'mg_%'::text);


--
-- Name: idx_chunks_parent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_parent ON public.chunks USING btree (parent_chunk_id);


--
-- Name: idx_chunks_phonetic_composite_local; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_phonetic_composite_local ON public.chunks USING gin (((((setweight(to_tsvector('english'::regconfig, content), 'A'::"char") || setweight(to_tsvector('english'::regconfig, COALESCE(content_audiobook_normalized, ''::text)), 'B'::"char")) || setweight(to_tsvector('english'::regconfig, COALESCE(content_soundex, ''::text)), 'C'::"char")) || setweight(to_tsvector('english'::regconfig, COALESCE(content_metaphone, ''::text)), 'D'::"char"))));


--
-- Name: idx_chunks_phonetic_metaphone; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_phonetic_metaphone ON public.chunks USING gin (to_tsvector('english'::regconfig, content_metaphone));


--
-- Name: idx_chunks_phonetic_soundex; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_phonetic_soundex ON public.chunks USING gin (to_tsvector('english'::regconfig, content_soundex));


--
-- Name: idx_chunks_similarity_optimized; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_similarity_optimized ON public.chunks USING btree (public.similarity(content, 'common search terms'::text)) WHERE ((content IS NOT NULL) AND ((length(content) >= 100) AND (length(content) <= 1000)));


--
-- Name: idx_chunks_soundex_performance; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_soundex_performance ON public.chunks USING btree (content_soundex) WHERE (content_soundex IS NOT NULL);


--
-- Name: idx_chunks_soundex_similarity; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_soundex_similarity ON public.chunks USING gin (content_soundex public.gin_trgm_ops) WHERE (content_soundex IS NOT NULL);


--
-- Name: idx_chunks_title_trigram; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_title_trigram ON public.chunks USING gin (title public.gin_trgm_ops);


--
-- Name: idx_chunks_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_chunks_vector_cosine; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_vector_cosine ON public.chunks USING hnsw (embedding_vector public.vector_cosine_ops) WITH (m='16', ef_construction='64');


--
-- Name: idx_chunks_vector_ip; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_vector_ip ON public.chunks USING hnsw (embedding_vector public.vector_ip_ops) WITH (m='16', ef_construction='64');


--
-- Name: idx_chunks_vector_l2; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_vector_l2 ON public.chunks USING hnsw (embedding_vector public.vector_l2_ops) WITH (m='16', ef_construction='64');
...
--
-- Name: idx_chunks_words_chapter; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chunks_words_chapter ON public.chunks USING btree (word_count DESC, chapter_number) WHERE ((chunk_type)::text = 'chapter'::text);


--
-- Name: idx_coffee_states_agent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_coffee_states_agent ON public.agent_coffee_states USING btree (agent_id);


--
-- Name: idx_coffee_states_expires; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_coffee_states_expires ON public.agent_coffee_states USING btree (expires_at);


--
-- Name: idx_coffee_states_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_coffee_states_status ON public.agent_coffee_states USING btree (status);


--
-- Name: idx_compound_concepts_phrase; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_compound_concepts_phrase ON public.compound_concepts USING gin (to_tsvector('english'::regconfig, full_phrase));


--
-- Name: idx_compound_concepts_priority; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_compound_concepts_priority ON public.compound_concepts USING btree (search_priority DESC);


--
-- Name: idx_compound_concepts_terms; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_compound_concepts_terms ON public.compound_concepts USING gin (component_terms);


--
-- Name: idx_config_history_config_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_config_history_config_id ON public.agent_config_history USING btree (config_id);


--
-- Name: idx_content_classifications_book; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_content_classifications_book ON public.content_classifications USING btree (book_id);


--
-- Name: idx_content_classifications_confidence; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_content_classifications_confidence ON public.content_classifications USING btree (confidence_score DESC);


--
-- Name: idx_content_classifications_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_content_classifications_type ON public.content_classifications USING btree (content_type);


--
-- Name: idx_description_log_book_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_description_log_book_id ON public.dr_elena_description_enhancement_log USING btree (book_id);


--
-- Name: idx_description_log_source; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_description_log_source ON public.dr_elena_description_enhancement_log USING btree (source_attempted);


--
-- Name: idx_description_log_success; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_description_log_success ON public.dr_elena_description_enhancement_log USING btree (success);


--
-- Name: idx_embedding_arctic_cosine; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_embedding_arctic_cosine ON public.chunks USING ivfflat (embedding_arctic public.vector_cosine_ops) WITH (lists='100');


--
-- Name: idx_embedding_bge_cosine; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_embedding_bge_cosine ON public.chunks USING ivfflat (embedding_bge public.vector_cosine_ops) WITH (lists='100');


--
-- Name: idx_embedding_granite_cosine; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_embedding_granite_cosine ON public.chunks USING ivfflat (embedding_granite public.vector_cosine_ops) WITH (lists='100');


--
-- Name: idx_embedding_mxbai_cosine; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_embedding_mxbai_cosine ON public.chunks USING ivfflat (embedding_mxbai public.vector_cosine_ops) WITH (lists='100');


--
-- Name: idx_embedding_nomic_cosine; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_embedding_nomic_cosine ON public.chunks USING ivfflat (embedding_nomic public.vector_cosine_ops) WITH (lists='100');


--
-- Name: idx_embedding_queue_chunk_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_embedding_queue_chunk_id ON public.embedding_queue USING btree (chunk_id);
...
--
-- Name: idx_embeddings_nomic_hnsw_768; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_embeddings_nomic_hnsw_768 ON public.chunk_embeddings USING hnsw (embedding_vector public.vector_cosine_ops) WHERE (((embedding_model)::text = 'nomic-embed-text'::text) AND (embedding_vector IS NOT NULL));


--
-- Name: idx_epub_migration_book_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_epub_migration_book_id ON public.dr_elena_epub_migration_log USING btree (book_id);


--
-- Name: idx_epub_migration_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_epub_migration_status ON public.dr_elena_epub_migration_log USING btree (migration_status);


--
-- Name: idx_extended_concepts_category; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_extended_concepts_category ON public.extended_semantic_concepts USING btree (semantic_category);


--
-- Name: idx_extended_concepts_complexity; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_extended_concepts_complexity ON public.extended_semantic_concepts USING btree (complexity_score, word_count, search_priority);


--
-- Name: idx_extended_concepts_components; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_extended_concepts_components ON public.extended_semantic_concepts USING gin (component_phrases);


--
-- Name: idx_factual_embeddings_book_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_factual_embeddings_book_id ON public.factual_embeddings USING btree (book_id);


--
-- Name: idx_factual_embeddings_chunk_level; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_factual_embeddings_chunk_level ON public.factual_embeddings USING btree (chunk_level);


--
-- Name: idx_factual_embeddings_hnsw; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_factual_embeddings_hnsw ON public.factual_embeddings USING hnsw (embedding public.vector_cosine_ops) WITH (m='16', ef_construction='64');
...
CREATE INDEX idx_global_settings_category ON public.global_agent_settings USING btree (setting_category);


--
-- Name: idx_hr_reports_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_hr_reports_date ON public.hr_daily_reports USING btree (report_date);


--
-- Name: idx_hr_reports_grade; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_hr_reports_grade ON public.hr_daily_reports USING btree (grade);


--
-- Name: idx_interactions_agent_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_interactions_agent_date ON public.agent_interactions USING btree (agent_id, date_trunc('day'::text, "timestamp"));


--
-- Name: idx_interactions_success_agent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_interactions_success_agent ON public.agent_interactions USING btree (success, agent_id);


--
-- Name: idx_learning_agent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_learning_agent ON public.agent_learning_history USING btree (agent_name);


--
-- Name: idx_learning_learned_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_learning_learned_at ON public.agent_learning_history USING btree (learned_at);


--
-- Name: idx_library_health_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_library_health_status ON public.library_health_checks USING btree (health_status);


--
-- Name: idx_library_health_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_library_health_time ON public.library_health_checks USING btree (check_time);


--
-- Name: idx_mapping_new_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mapping_new_id ON public.book_id_mapping USING btree (new_book_id);


--
-- Name: idx_mapping_old_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mapping_old_id ON public.book_id_mapping USING btree (old_book_id);


--
-- Name: idx_memory_metrics_agent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_metrics_agent ON public.agent_memory_optimization_metrics USING btree (agent_name);


--
-- Name: idx_memory_metrics_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_metrics_date ON public.agent_memory_optimization_metrics USING btree (date_measured);


--
-- Name: idx_metadata_conflicts_book_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_metadata_conflicts_book_id ON public.calibre_metadata_conflicts USING btree (book_id);


--
-- Name: idx_metadata_conflicts_timestamp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_metadata_conflicts_timestamp ON public.calibre_metadata_conflicts USING btree (conflict_timestamp);


--
-- Name: idx_processing_log_book_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_processing_log_book_id ON public.processing_log USING btree (book_id);


--
-- Name: idx_processing_log_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_processing_log_created_at ON public.processing_log USING btree (created_at);


--
-- Name: idx_processing_log_operation; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_processing_log_operation ON public.processing_log USING btree (operation);


--
-- Name: idx_query_cache_last_used; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_query_cache_last_used ON public.query_embeddings_cache USING btree (last_used);


--
-- Name: idx_query_performance_complexity; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_query_performance_complexity ON public.semantic_query_performance USING btree (word_count, complexity_score, execution_time_ms);


--
-- Name: idx_quote_cache_accessed; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_quote_cache_accessed ON public.quote_search_cache USING btree (last_accessed DESC);


--
-- Name: idx_quote_cache_hash; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_quote_cache_hash ON public.quote_search_cache USING btree (search_hash);


--
-- Name: idx_quote_cache_performance; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_quote_cache_performance ON public.quote_search_cache USING btree (is_high_performance, access_count DESC);
...
--
-- Name: idx_requests_type_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_requests_type_date ON public.user_requests USING btree (request_type, date_trunc('day'::text, "timestamp"));


--
-- Name: idx_routing_log_book; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_routing_log_book ON public.embedding_routing_log USING btree (book_id);


--
-- Name: idx_routing_log_content_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_routing_log_content_type ON public.embedding_routing_log USING btree (content_type);


--
-- Name: idx_routing_log_model; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_routing_log_model ON public.embedding_routing_log USING btree (selected_model);
...
--
-- Name: idx_search_history_execution_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_search_history_execution_time ON public.search_history USING btree (execution_time_ms);


--
-- Name: idx_search_history_query_text; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_search_history_query_text ON public.search_history USING gin (to_tsvector('english'::regconfig, query_text));


--
-- Name: idx_search_metrics_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_search_metrics_created ON public.search_performance_metrics USING btree (created_at DESC);


--
-- Name: idx_search_metrics_model; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_search_metrics_model ON public.search_performance_metrics USING btree (embedding_model);


--
-- Name: idx_search_metrics_strategy; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_search_metrics_strategy ON public.search_performance_metrics USING btree (routing_strategy);


--
-- Name: idx_semantic_chunks_book_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_chunks_book_id ON public.semantic_chunks USING btree (book_id);


--
-- Name: idx_semantic_chunks_entities; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_chunks_entities ON public.semantic_chunks USING gin (entities);


--
-- Name: idx_semantic_chunks_hash; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_chunks_hash ON public.semantic_chunks USING btree (content_hash);


--
-- Name: idx_semantic_chunks_keyphrases; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_chunks_keyphrases ON public.semantic_chunks USING gin (keyphrases);


--
-- Name: idx_semantic_chunks_level; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_chunks_level ON public.semantic_chunks USING btree (chunk_level);


--
-- Name: idx_semantic_embeddings_book_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_embeddings_book_id ON public.semantic_embeddings USING btree (book_id);


--
-- Name: idx_semantic_embeddings_chunk_level; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_embeddings_chunk_level ON public.semantic_embeddings USING btree (chunk_level);


--
-- Name: idx_semantic_embeddings_hnsw; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_embeddings_hnsw ON public.semantic_embeddings USING hnsw (embedding public.vector_cosine_ops) WITH (m='16', ef_construction='64');


--
-- Name: idx_semantic_ngrams_concepts; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_ngrams_concepts ON public.semantic_ngrams USING gin (related_concepts);


--
-- Name: idx_semantic_ngrams_size; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_ngrams_size ON public.semantic_ngrams USING btree (ngram_size, frequency_score DESC);


--
-- Name: idx_semantic_ngrams_text; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_ngrams_text ON public.semantic_ngrams USING gin (to_tsvector('english'::regconfig, ngram_text));


--
-- Name: idx_semantic_phrases_category; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_phrases_category ON public.semantic_phrases USING btree (concept_category);


--
-- Name: idx_semantic_phrases_normalized; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_phrases_normalized ON public.semantic_phrases USING btree (normalized_form);


--
-- Name: idx_semantic_phrases_weight; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_semantic_phrases_weight ON public.semantic_phrases USING btree (semantic_weight DESC);


--
-- Name: idx_social_connections_agent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_social_connections_agent ON public.agent_social_connections USING btree (agent_id);
...
CREATE INDEX idx_social_connections_type ON public.agent_social_connections USING btree (relationship_type);


--
-- Name: idx_stylistic_embeddings_book_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_stylistic_embeddings_book_id ON public.stylistic_embeddings USING btree (book_id);


--
-- Name: idx_stylistic_embeddings_chunk_level; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_stylistic_embeddings_chunk_level ON public.stylistic_embeddings USING btree (chunk_level);


--
-- Name: idx_stylistic_embeddings_hnsw; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_stylistic_embeddings_hnsw ON public.stylistic_embeddings USING hnsw (embedding public.vector_cosine_ops) WITH (m='16', ef_construction='64');


--
-- Name: idx_temporal_embeddings_book_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_temporal_embeddings_book_id ON public.temporal_embeddings USING btree (book_id);


--
-- Name: idx_temporal_embeddings_chunk_level; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_temporal_embeddings_chunk_level ON public.temporal_embeddings USING btree (chunk_level);


--
-- Name: idx_temporal_embeddings_hnsw; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_temporal_embeddings_hnsw ON public.temporal_embeddings USING hnsw (embedding public.vector_cosine_ops) WITH (m='16', ef_construction='64');
...
CREATE INDEX idx_token_usage_agent ON public.agent_token_usage_tracking USING btree (agent_name);


--
-- Name: idx_token_usage_session; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_token_usage_session ON public.agent_token_usage_tracking USING btree (session_id);


--
-- Name: idx_topical_embeddings_book_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_topical_embeddings_book_id ON public.topical_embeddings USING btree (book_id);


--
-- Name: idx_topical_embeddings_chunk_level; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_topical_embeddings_chunk_level ON public.topical_embeddings USING btree (chunk_level);


--
-- Name: idx_topical_embeddings_hnsw; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_topical_embeddings_hnsw ON public.topical_embeddings USING hnsw (embedding public.vector_cosine_ops) WITH (m='16', ef_construction='64');


--
-- Name: idx_user_requests_session; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_user_requests_session ON public.user_requests USING btree (user_session);


--
-- Name: idx_user_requests_timestamp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_user_requests_timestamp ON public.user_requests USING btree ("timestamp");
...
CREATE INDEX idx_user_requests_type ON public.user_requests USING btree (request_type);


--
-- Name: chunks trigger_update_book_chunk_count; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_update_book_chunk_count AFTER INSERT OR DELETE ON public.chunks FOR EACH ROW EXECUTE FUNCTION public.update_book_chunk_count();


--
-- Name: chunks trigger_update_book_word_count; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_update_book_word_count AFTER INSERT OR DELETE ON public.chunks FOR EACH ROW EXECUTE FUNCTION public.update_book_word_count();


--
-- Name: agent_interactions trigger_update_performance_score; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_update_performance_score BEFORE INSERT OR UPDATE ON public.agent_interactions FOR EACH ROW EXECUTE FUNCTION public.update_performance_score();


--
-- Name: chunks trigger_update_search_vector; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_update_search_vector BEFORE INSERT OR UPDATE ON public.chunks FOR EACH ROW EXECUTE FUNCTION public.update_search_vector();


--
-- Name: agent_auto_save_logs agent_auto_save_logs_checkpoint_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_auto_save_logs
    ADD CONSTRAINT agent_auto_save_logs_checkpoint_id_fkey FOREIGN KEY (checkpoint_id) REFERENCES public.agent_memory_checkpoints(checkpoint_id);


--
-- Name: agent_coffee_states agent_coffee_states_agent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_coffee_states
    ADD CONSTRAINT agent_coffee_states_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.agents(agent_id) ON DELETE CASCADE;


--
-- Name: agent_config_history agent_config_history_config_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_config_history
    ADD CONSTRAINT agent_config_history_config_id_fkey FOREIGN KEY (config_id) REFERENCES public.agent_configurations(config_id);
...
ALTER TABLE ONLY public.agent_interactions
    ADD CONSTRAINT agent_interactions_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.agents(agent_id) ON DELETE CASCADE;


--
-- Name: agent_interactions agent_interactions_request_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_interactions
    ADD CONSTRAINT agent_interactions_request_id_fkey FOREIGN KEY (request_id) REFERENCES public.user_requests(request_id);


--
-- Name: agent_posts agent_posts_agent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_posts
    ADD CONSTRAINT agent_posts_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.agents(agent_id) ON DELETE CASCADE;


--
-- Name: agent_social_connections agent_social_connections_agent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_social_connections
    ADD CONSTRAINT agent_social_connections_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.agents(agent_id) ON DELETE CASCADE;


--
-- Name: agent_social_connections agent_social_connections_connected_agent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_social_connections
    ADD CONSTRAINT agent_social_connections_connected_agent_id_fkey FOREIGN KEY (connected_agent_id) REFERENCES public.agents(agent_id) ON DELETE CASCADE;


--
-- Name: calibre_books calibre_books_postgres_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calibre_books
    ADD CONSTRAINT calibre_books_postgres_book_id_fkey FOREIGN KEY (postgres_book_id) REFERENCES public.books(book_id) ON DELETE CASCADE;


--
-- Name: calibre_file_sync calibre_file_sync_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calibre_file_sync
    ADD CONSTRAINT calibre_file_sync_book_id_fkey FOREIGN KEY (book_id) REFERENCES public.books(book_id);


--
-- Name: calibre_library_sync calibre_library_sync_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calibre_library_sync
    ADD CONSTRAINT calibre_library_sync_book_id_fkey FOREIGN KEY (book_id) REFERENCES public.books(book_id);


--
-- Name: calibre_metadata_conflicts calibre_metadata_conflicts_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calibre_metadata_conflicts
    ADD CONSTRAINT calibre_metadata_conflicts_book_id_fkey FOREIGN KEY (book_id) REFERENCES public.books(book_id);


--
-- Name: chunk_extended_semantics chunk_extended_semantics_chunk_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_extended_semantics
    ADD CONSTRAINT chunk_extended_semantics_chunk_id_fkey FOREIGN KEY (chunk_id) REFERENCES public.chunks(chunk_id) ON DELETE CASCADE;


--
-- Name: chunk_extended_semantics chunk_extended_semantics_concept_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_extended_semantics
    ADD CONSTRAINT chunk_extended_semantics_concept_id_fkey FOREIGN KEY (concept_id) REFERENCES public.extended_semantic_concepts(concept_id) ON DELETE CASCADE;


--
-- Name: chunk_processed_terms chunk_processed_terms_chunk_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_processed_terms
    ADD CONSTRAINT chunk_processed_terms_chunk_id_fkey FOREIGN KEY (chunk_id) REFERENCES public.chunks(chunk_id) ON DELETE CASCADE;


--
-- Name: chunk_semantic_phrases chunk_semantic_phrases_chunk_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_semantic_phrases
    ADD CONSTRAINT chunk_semantic_phrases_chunk_id_fkey FOREIGN KEY (chunk_id) REFERENCES public.chunks(chunk_id) ON DELETE CASCADE;


--
-- Name: chunk_semantic_phrases chunk_semantic_phrases_phrase_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_semantic_phrases
    ADD CONSTRAINT chunk_semantic_phrases_phrase_id_fkey FOREIGN KEY (phrase_id) REFERENCES public.semantic_phrases(phrase_id) ON DELETE CASCADE;


--
-- Name: cross_training_progress cross_training_progress_training_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cross_training_progress
    ADD CONSTRAINT cross_training_progress_training_id_fkey FOREIGN KEY (training_id) REFERENCES public.emergency_cross_training(training_id);


--
-- Name: dr_elena_description_enhancement_log dr_elena_description_enhancement_log_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dr_elena_description_enhancement_log
    ADD CONSTRAINT dr_elena_description_enhancement_log_book_id_fkey FOREIGN KEY (book_id) REFERENCES public.books(book_id);


--
-- Name: dr_elena_epub_migration_log dr_elena_epub_migration_log_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dr_elena_epub_migration_log
    ADD CONSTRAINT dr_elena_epub_migration_log_book_id_fkey FOREIGN KEY (book_id) REFERENCES public.books(book_id);


--
-- Name: mentorship_progress mentorship_progress_relationship_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mentorship_progress
    ADD CONSTRAINT mentorship_progress_relationship_id_fkey FOREIGN KEY (relationship_id) REFERENCES public.mentorship_relationships(relationship_id);


--
-- Name: training_progress training_progress_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.training_progress
    ADD CONSTRAINT training_progress_plan_id_fkey FOREIGN KEY (plan_id) REFERENCES public.cross_training_plans(plan_id);
