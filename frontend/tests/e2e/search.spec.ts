...
test.describe("LibraryOfBabel Search Functionality", () => {
  ...
  test("should handle very long search queries", async ({ page }) => {
    const longQuery =
      "consciousness ethics philosophy artificial intelligence machine learning deep learning neural networks cognitive science psychology neuroscience phenomenology existentialism poststructuralism critical theory social theory political philosophy economic theory".repeat(
        3,
      );
  ...
  test("should support semantic search", async ({ page }) => {
    ...
    await page.fill(
      '[data-testid="search-input"]',
      "books about AI consciousness and ethics",
    );
    await page.click('[data-testid="search-button"]');
