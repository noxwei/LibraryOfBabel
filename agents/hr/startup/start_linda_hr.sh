...
python3 /Users/weixiangzhang/Local Dev/LibraryOfBabel/agents/hr/api/hr_api.py &
HR_API_PID=$!
...
echo $HR_API_PID > "/Users/weixiangzhang/Local Dev/LibraryOfBabel/agents/hr/startup/hr_pids.txt"
